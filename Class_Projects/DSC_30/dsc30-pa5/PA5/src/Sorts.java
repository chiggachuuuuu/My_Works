...
public class Sorts {
     ...
     * @param lo low
     * @param hi high
     * @return The index of the arraylist to split and pass in to the next iteration
     */
    ...
    /**
     * Inspection of whether a given arraylist could be possibly
     * applied with Insertion Sort after n iterations
     *
     * @param arr The arraylist to be checked
     * @param n number of iteration
     * @return true if this algorithm could have been insertion sort and false otherwise.
     */
    ...
    /**
     * Inspection of whether a given arraylist could be possibly
     * applied with Selection Sort after n iterations
     *
     * @param arr The arraylist to be checked
     * @param n number of iteration
     * @return true if this algorithm could have been selection sort and false otherwise.
     */
    ...
    /**
     * Inspection of whether a given arraylist could be possibly
     * applied with Merge Sort after n iterations
     *
     * @param arr The arraylist to be checked
     * @param n number of iteration
     * @return true if this algorithm could have been merge sort and false otherwise.
     */
