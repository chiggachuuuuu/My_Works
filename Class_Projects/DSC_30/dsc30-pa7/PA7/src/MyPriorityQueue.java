...
public class MyPriorityQueue<T extends Comparable<? super T>> {
    ...
    private static final int DEFAULT_BRANCH = 4;
    ...
    public MyPriorityQueue(int initialSize) {
        this.pQueue = new dHeap<>(DEFAULT_BRANCH,initialSize, false);
    }
     ...
     *
     * @return true if MyPriorityQueue is empty, false otherwise.
     */
