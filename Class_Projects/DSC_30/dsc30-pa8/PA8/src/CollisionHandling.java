...
public class CollisionHandling {
    ...
    public static int[][] linearProbingResult(){
        int[][] output = new int[][]{{0, 24, 5, 42, 0, 28, 0, 0},
                {11, 24, 5, 42, 77, 28, 84, 98}};
        return output;
    }
    ...
    public static int[][] quadraticProbingResult(){
        int[][] output = new int[][]{{101, 0, 0, 16, 0, 26, 11, 0},
                {101, 0, 0, 16, 33, 26, 11, 0, 9, 2, 0, 0, 0, 201, 0, 0}};
        return output;
    }
    ...
    public static int[][] doubleHashingResult(){
        int[][] output = new int[][]{{0, 107, 100, 0, 12, 3, 0, 0},
                {0, 107, 0, 41, 12, 3, 0, 51, 0, 39, 100, 0, 0, 51, 0, 0}};
        return output;
    }
